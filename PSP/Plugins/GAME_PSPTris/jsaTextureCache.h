...
*/
#ifndef _JSA_TEXTURECACHE_H_
#define _JSA_TEXTURECACHE_H_
...
public:
	...
	void jsaTCacheLoadTextureSet(const char* path, jsaTextureFile *TextureSet, int count);
