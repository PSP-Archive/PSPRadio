...
{ pccUnknown = 0, pccDocumentBottom = 1, pccDocumentEnforceHtml = 2,
  ...
  pccQuit = 45, pccScreenSplit = 46, pccScreenSwitch = 47,
...
{ { '!', pccExecextShell },
  ...
  { 3, pccGoSearch },
  { KEY_END, pccDocumentBottom },
  { KEY_PSP_CROSS, pccElementOpen },
  { KEY_PSP_SELECT, pccGoUri },
  { 'h', pccGoHome },
  { KEY_HOME, pccDocumentTop },
  { 'i', pccElementInfo },
  { KEY_IC, pccLineUp },
  { 'j', pccJump },
  { 'l', pccLineDown },
  { KEY_PSP_START, pccMenuContextual },
  { 'O', pccWindowNew },
  { 'o', pccElementOpen },
  { KEY_NPAGE, pccPageDown },
  { KEY_PPAGE, pccPageUp },
...
static void cm_setup_menu_psp(void)
{
	int x, y, _ae;
  tWindow* window = current_window_x; /* FIXME! */
  void (*func)(tWindow*, short*, short*, tActiveElementNumber) =
...
#endif /* #if CONFIG_MENUS & MENUS_PSP */
